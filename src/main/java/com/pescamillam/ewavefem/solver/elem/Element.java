...
public abstract class Element {
    ...
    protected static final Logger LOGGER = Logger.getLogger("Window");
    ...
    public static double xy[][] = new double[20][3];
    ...
    public static Element newElement(String name) {
        ...
        try {
            ...
            LOGGER.info("Incorrect element type: " + name);
        }
        return el.create();
    }
    ...
    public Element(String name, int nind, int nstress) {
        this.name = name;
        ind = new int[nind];
        if (FemConstants.main != FemConstants.JMGEN) {
