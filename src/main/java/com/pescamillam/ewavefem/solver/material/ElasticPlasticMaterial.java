package com.pescamillam.ewavefem.solver.material;
...
public class ElasticPlasticMaterial extends ElasticMaterial {
    ...
    public ElasticPlasticMaterial(String stressState) {
        ...
        if (stressState.equals("plstress"))
            LOGGER.info("Elastic-plastic material is not implemented for plane stress");
        if (!FemConstants.epIntegrationTANGENT)
    ...
    public void strainToStress(Element elm, int ip) {
        ...
        int nsub = (FemConstants.epIntegrationTANGENT) ?
                (int) (f1/(beta*sY))+1 : 1;
